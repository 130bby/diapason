...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'digin_userbundle_usertype.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDiginUserbundleUsertype_Form_TypeService()
    {
        return $this->services['digin_userbundle_usertype.form.type'] = new \Digin\UserBundle\Form\UserType('Digin\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Transport_RealService()
    {
        ...
        $instance->setHost('mail.3ad.digin.fr');
        $instance->setPort(25);
        $instance->setEncryption(NULL);
        $instance->setUsername('contact@3ad.digin.fr');
        $instance->setPassword('123dev');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => 'mail.3ad.digin.fr',
            'mailer_user' => 'contact@3ad.digin.fr',
            'mailer_password' => '123dev',
            'locale' => 'fr',
            ...
            'swiftmailer.transport.smtp.host' => 'mail.3ad.digin.fr',
            'swiftmailer.transport.smtp.username' => 'contact@3ad.digin.fr',
            'swiftmailer.transport.smtp.password' => '123dev',
