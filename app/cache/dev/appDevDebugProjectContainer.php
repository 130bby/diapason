...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'E:/websites/diapason/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('E:/websites/diapason/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'E:/websites/diapason/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'E:/websites/diapason/app/Resources');
    ...
    /**
     * Gets the 'digin_user_registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Digin\UserBundle\Form\UserType A Digin\UserBundle\Form\UserType instance.
     */
    protected function getDiginUserRegistrationService()
    {
        return $this->services['digin_user_registration'] = new \Digin\UserBundle\Form\UserType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EM5086029a90340_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EM5086029a90340_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'E:/websites/diapason/app/cache/dev/jms_diextra/doctrine/EntityManager.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_e1f104597cc0bc6851dc7c58340acc54');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e1f104597cc0bc6851dc7c58340acc54');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e1f104597cc0bc6851dc7c58340acc54');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('E:\\websites\\diapason\\vendor\\bundles\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'FOS\\UserBundle\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'E:\\websites\\diapason\\src\\Digin\\UserBundle\\Entity')), 'Digin\\UserBundle\\Entity');
        ...
        $f->setProxyDir('E:/websites/diapason/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EM5086029a90340_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'E:/websites/diapason/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'digin_user_registration', NULL, array('validation_groups' => array(0 => 'Registration')));
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('E:/websites/diapason/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('E:/websites/diapason/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:E:/websites/diapason/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'E:/websites/diapason/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'E:/websites/diapason/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('CONFIRMED_USER' => array(0 => 'ROLE_USER'), 'ROLE_CFA' => array(0 => 'CONFIRMED_USER'), 'ROLE_3AD' => array(0 => 'ROLE_CFA', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('E:/websites/diapason/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('E:/websites/diapason/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('E:/websites/diapason/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'E:/websites/diapason/app', 'UTF-8');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', 'E:\\websites\\diapason\\src\\Digin\\HomeBundle/Resources/translations\\FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        ...
        $instance->addResource('xlf', 'E:\\websites\\diapason\\src\\Digin\\AdminBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'E:/websites/diapason/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('E:\\websites\\diapason\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
     ...
     *
     * @return EM5086029a90340_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'E:/websites/diapason/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('E:/websites/diapason/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('E:/websites/diapason/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('E:/websites/diapason/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'E:/websites/diapason/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'E:\\websites\\diapason\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'E:\\websites\\diapason\\vendor\\bundles\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'E:\\websites\\diapason\\vendor\\bundles\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'E:/websites/diapason/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'E:/websites/diapason/app/cache/dev',
            'kernel.logs_dir' => 'E:/websites/diapason/app/logs',
            'kernel.bundles' => array(
                ...
                'DiginAdminBundle' => 'Digin\\AdminBundle\\DiginAdminBundle',
            ...
            'debug.container.dump' => 'E:/websites/diapason/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'E:/websites/diapason/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'E:\\websites\\diapason\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'E:\\websites\\diapason\\vendor\\bundles\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'E:\\websites\\diapason\\vendor\\bundles\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:E:/websites/diapason/app/cache/dev/profiler',
            ...
            'router.resource' => 'E:/websites/diapason/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'E:/websites/diapason/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'E:/websites/diapason/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'E:/websites/diapason/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'E:/websites/diapason/app/../web',
            'assetic.write_to' => 'E:/websites/diapason/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'E:/websites/diapason/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'E:/websites/diapason/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'E:/websites/diapason/app/cache/dev/jms_diextra',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EM5086029a90340_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'E:/websites/diapason/app/cache/dev/jms_security',
            ...
            'fos_user.registration.form.type' => 'digin_user_registration',
